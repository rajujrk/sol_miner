...
# zil + etc + ironfish
./bzminer -a etchash -w 0000 -p ethstratum+tcp://etc-us-east.flexpool.io:4444 --a2 ironfish --w2 1111 -p stratum+tcp://iron.fpmp.net:8888 --a3 zil --w3 2222 --p3 zmp://zil.flexpool.io

# zil + octa + radiant
#./bzminer -a octa -w 0000 -p ethproxy+ssl://us.vipor.net:5104 --a2 radiant --w2 1111 -p stratum+tcp://pool.us.woolypooly.com:3122 --a3 zil --w3 2222 --p3 zmp://zil.flexpool.io

# zil + etc + kas
#./bzminer -a etchash -w 0000 -p stratum+tcp://us1-etc.ethermine.org:4444 --a2 kaspa --w2 1111 --p2 stratum+tcp://pool.woolypooly.com:3112 --a3 zil --w3 2222 --p3 zmp://zil.flexpool.io
